...
#nullable restore annotations
    {
        ...
        if (OnAdd is null)
        {
            throw new InvalidOperationException($"Material.Blazor: you attempted to show a toast notification from a {Utilities.GetTypeName(typeof(IMBToastService))} but have not placed an MBAnchor component at the top of either App.razor or MainLayout.razor");
        }
