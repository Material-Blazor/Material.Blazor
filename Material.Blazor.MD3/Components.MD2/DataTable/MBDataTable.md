...
A partial implementation of a [Material Data Table](https://github.com/material-components/material-components-web/tree/v9.0.0/packages/mdc-data-table#data-tables) built using render fragments. It features:
