...
namespace BPlus
{
    ...
    internal class AnimatedNavigationManager : IAnimatedNavigationManager
    {
        ...
        public void NavigateTo(string uri, bool forceLoad = false)
        {
            ...
            {
                throw new InvalidOperationException($"BlazorMdc: you have registered a {BBase.Utilities.GetTypeName(typeof(IAnimatedNavigationManager))} but have not placed a {BBase.Utilities.GetTypeName(typeof(AnimatedNavigation))} component around your markup in either App.razor or MainLayout.razor");
            }
