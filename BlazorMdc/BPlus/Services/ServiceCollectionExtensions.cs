...
namespace BPlus
{
    public static class ServiceCollectionExtensions
    {
        ...
        /// </example>
        /// </summary>
        public static IServiceCollection AddBPlusToastService(this IServiceCollection services, ToastServiceConfiguration configuration = null)
        {
        ...
        /// </example>
        /// </summary>
        public static IServiceCollection AddBPlusAnimatedNavigationManager(this IServiceCollection services, AnimatedNaviationManagerConfiguration configuration = null)
        {
            if (configuration == null)
            {
