...
#nullable restore annotations
        ...
        internal BEnum.ToastCloseMethod AppliedCloseMethod => (CloseMethod is null) ? Configuration?.CloseMethod ?? ToastServiceConfiguration.DefaultCloseMethod : (BEnum.ToastCloseMethod)CloseMethod;
        ...
        {
            BEnum.ToastLevel.Error => Configuration?.ErrorIconName ?? ToastServiceConfiguration.DefaultErrorIconName,
            BEnum.ToastLevel.Info => Configuration?.InfoIconName ?? ToastServiceConfiguration.DefaultInfoIconName,
            BEnum.ToastLevel.Success => Configuration?.SuccessIconName ?? ToastServiceConfiguration.DefaultSuccessIconName,
            BEnum.ToastLevel.Warning => Configuration?.WarningIconName ?? ToastServiceConfiguration.DefaultWarningIconName,
            _ => throw new InvalidOperationException(),
        };
