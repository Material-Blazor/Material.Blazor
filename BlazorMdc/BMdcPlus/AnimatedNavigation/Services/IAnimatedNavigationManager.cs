namespace BMdcPlus
{
    ...
    public interface IAnimatedNavigationManager
    {
        ...
        /// </summary>
        public AnimatedNaviationManagerConfiguration Configuration { get; set; }
        ...
        internal void RegisterNavigationComponent(AnimatedNavigation navigationComponent);
        ...
        /// </summary>
        /// <param name="navigationComponent"></param>
        internal void DeregisterNavigationComponent(AnimatedNavigation navigationComponent);
    }
}
