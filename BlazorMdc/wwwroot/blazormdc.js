...
window.BlazorMdc = {
    autoComplete: {
        ...
        open: function open(menuElem, dotNetObject) {
    ...
    iconButtonToggle: {
        init: function init(elem, dotNetObject) {
