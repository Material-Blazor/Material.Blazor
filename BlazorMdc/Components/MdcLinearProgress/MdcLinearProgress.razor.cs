...
namespace BlazorMdc
{
    ...
    public partial class MdcLinearProgress : MdcInputComponentBase<double>
    {
        ...
        /// <inheritdoc/>
        protected override void ValueSetter(double value) => InvokeAsync(async () => await JsRuntime.InvokeAsync<object>("BlazorMdc.linearProgress.setProgress", ElementReference, Value, MyBufferValue));
