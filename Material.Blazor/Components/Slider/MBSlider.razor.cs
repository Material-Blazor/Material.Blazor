...
namespace Material.Blazor
{
    ...
    public partial class MBSlider : InputComponent<decimal>
    {
        ...
        /// <inheritdoc/>
        private protected override Task InstantiateMcwComponent() => InvokeVoidAsync("MaterialBlazor.MBSlider.init", ElementReference, ObjectReference, EventType, ContinuousInputDelay);
    }
}
