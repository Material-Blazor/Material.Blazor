...
namespace Material.Blazor
{
    ...
    public partial class MBTabBar<TItem> : InputComponent<int>
    {
        ...
        /// <param name="e"></param>
        protected void OnValueSetCallback() => InvokeAsync(() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBTabBar.activateTab", ElementReference, Value));


        /// <inheritdoc/>
        private protected override Task InstantiateMcwComponent() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBTabBar.init", ElementReference, ObjectReference);
    }
}
