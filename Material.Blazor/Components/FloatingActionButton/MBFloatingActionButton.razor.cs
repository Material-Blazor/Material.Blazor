        ...
        public bool Exited
        {
            ...
            set
            {
                if (value != exited)
                {
                    ...
                    if (HasInstantiated)
                    {
                        InvokeAsync(() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBFloatingActionButton.setExited", ElementReference, Exited));
                    }
                }
            }
        }
#nullable restore annotations
        ...
        /// <inheritdoc/>
        private protected override Task InstantiateMcwComponent() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBFloatingActionButton.init", ElementReference, Exited);
    }
}
