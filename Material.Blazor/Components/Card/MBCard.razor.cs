...
namespace Material.Blazor
{
    ...
    public partial class MBCard : ComponentFoundation
    {
        ...
        /// <inheritdoc/>
        private protected override Task InstantiateMcwComponent() => PrimaryAction != null ? InvokeVoidAsync("MaterialBlazor.MBCard.init", PrimaryActionReference) : Task.CompletedTask;
    }
}
