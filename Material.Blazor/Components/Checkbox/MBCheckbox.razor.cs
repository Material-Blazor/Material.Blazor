...
namespace Material.Blazor
{
    ...
    public partial class MBCheckbox : InputComponent<bool>
    {
        ...
        {
            return InvokeBatchingJsVoidAsync("MaterialBlazor.MBCheckbox.setIndeterminate", ElementReference, IsIndeterminate);
        }
        ...
        /// <param name="e"></param>
        protected void OnValueSetCallback() => InvokeAsync(() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBCheckbox.setChecked", ElementReference, Value));
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void OnDisabledSetCallback() => InvokeAsync(() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBCheckbox.setDisabled", ElementReference, AppliedDisabled));


        /// <inheritdoc/>
        private protected override Task InstantiateMcwComponent() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBCheckbox.init", ElementReference, FormReference, ComponentValue, IsIndeterminate);
    }
}
