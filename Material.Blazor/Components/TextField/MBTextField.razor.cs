...
#nullable restore annotations
        ...
        /// <param name="e"></param>
        protected void OnValueSetCallback() => InvokeAsync(() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBTextField.setValue", ElementReference, Value));
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void OnDisabledSetCallback() => InvokeAsync(() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBTextField.setDisabled", ElementReference, AppliedDisabled));


        /// <inheritdoc/>
        private protected override Task InstantiateMcwComponent() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBTextField.init", ElementReference, HelperTextReference, HelperText.Trim(), HelperTextPersistent, PerformsValidation);
        ...
        /// </summary>
        /// <returns></returns>
        internal Task SetType(string value, string type, bool formNoValidate) => InvokeBatchingJsVoidAsync("MaterialBlazor.MBTextField.setType", ElementReference, value, InputReference, type, formNoValidate);
        ...
        private void OnValidationStateChangedCallback(object sender, EventArgs e)
        {
            if (ValidationMessageFor != null)
            {
                ...
                InvokeAsync(() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBTextField.setHelperText", ElementReference, HelperTextReference, HelperText.Trim(), HelperTextPersistent, PerformsValidation, !string.IsNullOrEmpty(Value), validationMessage));
            }
        }
    }
}
