...
#nullable restore annotations
        ...
        /// <param name="e"></param>
        protected void OnValueSetCallback(object sender, EventArgs e) => InvokeAsync(() => JsRuntime.InvokeVoidAsync("MaterialBlazor.textField.setValue", ElementReference, Value));
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void OnDisabledSetCallback(object sender, EventArgs e) => InvokeAsync(() => JsRuntime.InvokeVoidAsync("MaterialBlazor.textField.setDisabled", ElementReference, AppliedDisabled));


        /// <inheritdoc/>
        private protected override async Task InitializeMdcComponent() => await JsRuntime.InvokeVoidAsync("MaterialBlazor.textField.init", ElementReference, HelperTextReference, HelperText.Trim(), HelperTextPersistent, PerformsValidation);
        ...
        /// </summary>
        /// <returns></returns>
        internal async Task Select() => await JsRuntime.InvokeVoidAsync("MaterialBlazor.textField.select", InputReference);
        ...
        /// </summary>
        /// <returns></returns>
        internal async Task SetType(string value) => await JsRuntime.InvokeVoidAsync("MaterialBlazor.textField.setType", InputReference, value);
