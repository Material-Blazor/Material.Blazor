...
namespace Material.Blazor.Internal
{
    public partial class InternalSnackbar : ComponentFoundation
    {
        ...
        /// <inheritdoc/>
        private protected override Task InstantiateMcwComponent() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBSnackbar.init", SnackbarReference, ObjectReference, Snackbar.Settings.AppliedTimeout);
    }
}
