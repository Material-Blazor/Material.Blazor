...
namespace Material.Blazor
{
    ...
    public partial class MBDataTable<TItem> : ComponentFoundation
    {
        ...
        public bool ShowProgress
        {
            ...
            set
            {
                if (value != showProgress)
                {
                    ...
                    {
                        InvokeAsync(() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBDataTable.setProgress", ElementReference, showProgress));
                    }
                }
            }
        }
        ...
        /// <inheritdoc/>
        private protected override Task InstantiateMcwComponent() => InvokeBatchingJsVoidAsync("MaterialBlazor.MBDataTable.init", ElementReference, HasProgressBar, ShowProgress);
    }
}
