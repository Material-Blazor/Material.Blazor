...
namespace Material.Blazor
{
    ...
    public partial class MBChipsSelectMulti<TItem> : MultiSelectComponent<TItem, MBIconBearingSelectElement<TItem>>
    {
        ...
        private NoThrowDotNetObjectReference<MBChipsSelectMulti<TItem>> ObjectReference { get; set; }
        ...
        /// <inheritdoc/>
        private protected override Task InstantiateMcwComponent() => InvokeVoidAsync("MaterialBlazor.MBChipsSelectMulti.init", ChipsReference, IsSingleSelect, ObjectReference);
