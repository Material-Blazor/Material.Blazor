...
namespace Material.Blazor
{
    ...
    /// </summary>
    public partial class MBYearPadPanel : InputComponent<DateTime>
    {
        #region members
        ...
        private DotNetObjectReference<MBYearPadPanel> ObjectReference { get; set; }
        ...
        private InternalYearPadPanel Panel { get; set; }
...
#nullable restore annotations
        ...
        /// <inheritdoc/>
        private protected override Task InstantiateMcwComponent() => InvokeJsVoidAsync("MaterialBlazor.MBDatePicker.init", ElementReference, MenuSurfaceElementReference, ObjectReference);
