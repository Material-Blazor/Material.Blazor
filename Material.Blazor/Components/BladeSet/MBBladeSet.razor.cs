...
namespace Material.Blazor
{
    ...
    public partial class MBBladeSet : ComponentFoundation
    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            {
                await InvokeBatchingJsVoidAsync("MaterialBlazor.MBBladeSet.openBlade", addedBlade.BladeElementReference, addedBlade.BladeContentElementReference, transitionMs);
            ...
            {
                await InvokeBatchingJsVoidAsync("MaterialBlazor.MBBladeSet.closeBlade", removedBlade.BladeElementReference, transitionMs);
