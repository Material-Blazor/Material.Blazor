...
You can read the project documentation at https://BlazorMdc.github.io/BlazorMdc. We expect to release BlazorMdc version 1 within the coming weeks once documentation is finalized and we have conducted a thorough code review. We now consider the API stable.
