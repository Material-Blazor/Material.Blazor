...
Material.Blazor has two services for  snackbars and tooltips. We strongly advise you to use these in your project
...
The two configurations are either the default (as above) or custom - 
