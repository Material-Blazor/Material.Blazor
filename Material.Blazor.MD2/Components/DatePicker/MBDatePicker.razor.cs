...
/// </summary>
public partial class MBDatePicker : InputComponentMD2<DateTime>
{
    #region members
    ...
    private readonly string labelId = UtilitiesMD2.GenerateUniqueElementName();
    private readonly string listboxId = UtilitiesMD2.GenerateUniqueElementName();
    private readonly string selectedTextId = UtilitiesMD2.GenerateUniqueElementName();
...
#nullable restore annotations
    ...
    protected private override async Task SetComponentValueAsync()
    {
        ...
        await InvokeJsVoidAsync("MaterialBlazor.MBDatePicker.listItemClick", Panel.ListItemReference, UtilitiesMD2.DateToString(Value, AppliedDateFormat)).ConfigureAwait(false);
    }
