...
/// </summary>
public partial class InternalDatePickerPanel : InputComponentMD2<DateTime>
{
    /// <summary>
...
#nullable restore annotations
    ...
    private string ValueText => UtilitiesMD2.DateToString(Value, DateFormat);
    ...
    private readonly string currentYearId = UtilitiesMD2.GenerateUniqueElementName();
    ...
    private async Task OnDayItemClickAsync(DateTime dateTime)
    {
        ...
        await InvokeJsVoidAsync("MaterialBlazor.MBDatePicker.listItemClick", ListItemReference, UtilitiesMD2.DateToString(dateTime, DateFormat));
