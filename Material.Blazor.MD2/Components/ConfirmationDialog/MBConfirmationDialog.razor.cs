...
/// </summary>
public partial class MBConfirmationDialog : ComponentFoundationMD2
{
    ...
    protected override async Task OnParametersSetAsync()
    {
        ...
        {
            throw new ArgumentException($"Material.Blazor.MD2: UnconfirmedButtons and ConfirmedButton in {UtilitiesMD2.GetTypeName(this.GetType())} must both be either null or not null");
        }
    }
