...
/// </summary>
public class MBGrid<TRowData> : ComponentFoundationMD2
{
    #region Members
...
#nullable restore annotations
    ...
    private string GridBodyID { get; set; } = UtilitiesMD2.GenerateUniqueElementName();
    private string GridHeaderID { get; set; } = UtilitiesMD2.GenerateUniqueElementName();
