        ...
        else
        {
            ...
            if (IsSecondMeasurementCompleted)
            {
                foreach (var appt in Appointments)
                {
                    ...
                    appt.RelativeY = y;
                    appt.Width = w;
                    //builder.OpenComponent<Material.Blazor.MD2.Internal.MBAppointment>(rendSeq++);
                    //builder.AddAttribute(rendSeq++, "Height", h);
                    //builder.AddAttribute(rendSeq++, "SchedulerAppointment", appt);
                    //builder.AddAttribute(
                    //    rendSeq++,
                    //    "SchedulerRef",
                    //    global::Microsoft.AspNetCore.Components.CompilerServices.RuntimeHelpers.TypeCheck<Material.Blazor.MD2.MBScheduler>(
                    //    this));
