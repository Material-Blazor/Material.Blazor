...
#nullable restore annotations
    {
        ...
        if (OnAdd is null)
        {
            throw new InvalidOperationException($"Material.Blazor.MD2: you attempted to show a snackbar notification from a {Utilities.GetTypeName(typeof(IMBSnackbarService))} but have not placed an MBAnchor component at the top of either App.razor or MainLayout.razor");
        }
